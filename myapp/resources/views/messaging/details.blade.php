                ...
                <div class="mail-tools tooltip-demo m-t-md">
                    ...
                    <h5>
                        ...
                        @if($message->messageFlag == 'sent')
                            <span class="font-noraml">To: </span><label class="label label-success"> Admin</label>
                        @else
                        <span class="font-noraml">From: </span><label class="label label-success"> Admin</label>
                        @endif
                    </h5>
                </div>
            </div>
